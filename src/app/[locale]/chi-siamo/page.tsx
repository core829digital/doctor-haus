...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const keywordsIt = "chi siamo doctor haus, storia montaggi srl, esperienza case modulari, brand apple cabin italia, progettazione strutture modulari, team esperti case prefabbricate, box prefabbricati coibentati, BOX PREFABBRICATI COIBENTATI".trim();
  const keywordsEn = "doctor haus story, montaggi srl experience, modular house design, apple cabin italy brand, prefabricated house design, modular home experts team, box prefabricated insulated, BOX PREFABBRICATED INSULATED".trim();
