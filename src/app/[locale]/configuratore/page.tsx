...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const keywordsIt = "configuratore apple cabin, designer house modulare, personalizza mini casa, preventivo casa modulare, apple cabin finiture, casa modulare personalizzata, moduli abitativi configurazione, box prefabbricati coibentati, BOX PREFABBRICATI COIBENTATI".trim();
  const keywordsEn = "apple cabin configurator, design modular house, customize mini house, modular house quote, apple cabin finishes, customized modular home, modular unit configuration, box prefabricated insulated, BOX PREFABBRICATED INSULATED".trim();
