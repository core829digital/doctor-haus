...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<import("next").Metadata> {
  ...
  const keywordsIt = "apple cabin, doctor haus, mini case modulari, case prefabbricate di design, case modulari prefabbricate, design arrotondato, vetrate a tutta altezza, box prefabbricati coibentati, BOX PREFABBRICATI COIBENTATI, isolamento lana di roccia, pannelli eps isolanti, efficienza energetica, abitare sostenibile, chiavi in mano, preventivo, configuratore, glamping, resort, mini case giardino, moduli abitativi, strutture abitative portatili, architettura modulare moderna, design abitativo innovativo, case eco-friendly, produttori apple cabin italia".trim();
  const keywordsEn = "apple cabin, doctor haus, modular modular mini houses, design prefabricated houses, modular prefabricated houses, rounded design, full-height windows, box prefabricated insulated, BOX PREFABBRICATED INSULATED, rock wool insulation, EPS panels, energy efficiency, sustainable living, turnkey, quote, configurator, glamping, resort, garden mini homes, modular units, portable habitation structures, modern modular architecture, innovative home design, eco-friendly houses, apple cabin italy producers".trim();
