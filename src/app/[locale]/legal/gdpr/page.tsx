...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    alternates: buildAlternates(locale, "legal/gdpr"),
...
export default async function GDPRPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const content = locale === "it" ? {
    ...
    sections: [
      ...
      { title: "Data Protection Officer (DPO)", content: "Il DPO può essere contattato all'indirizzo email dpo@doctor-haus.com. Il DPO è il referente per tutte le comunicazioni relative al trattamento dei dati personali e all'esercizio dei diritti degli interessati." },
    ...
    sections: [
      ...
      { title: "Data Protection Officer (DPO)", content: "The DPO can be contacted at dpo@doctor-haus.com. The DPO is the point of contact for all communications regarding personal data processing and the exercise of data subjects' rights." },
